...
public class DataFormat {
	...
	public static DataFormatResult<Boolean, String, String, String>  formatPlateInfo(Document document){
		...
		return new DataFormatResult<Boolean, String, String, String>(true, stringBuffer.toString(), "xml解析成功",PropertiesUtil.getName("PASS_TOPIC"));
	}
	/**
	 * 标准化流量数据
	 * @param document
	...
	public static DataFormatResult<Boolean,List<String>, String, String>  formatTrafficMeasure(Document document){
		...
		return new DataFormatResult<Boolean, List<String>, String, String>( true , list , "xml解析成功",PropertiesUtil.getName("FLOW_TOPIC"));
	}
	/**
	 * 标准化流量数据多个Volumes格式
	 * @param document
...
//视频地址
		...
		return new DataFormatResult<Boolean, List<String>, String, String>( true , list , "xml解析成功",PropertiesUtil.getName("TRAFFIC_TOPIC"));
	}
	/**
	 * 标准化交通事件数据
	 * @param document
	...
	public static DataFormatResult<Boolean, String, String, String>  formatViolationInfoVRoad(Document document){
		...
		for(int i=0;i<4;i++) {
			if(i<Integer.parseInt(nodeValue)) {
				...
				stringBuffer2.append("/cifspool");
				//服务路径
//				stringBuffer2.append("/").append(ENUMS.ipPath.get(PropertiesUtil.getName("SERVER_IP")));
				stringBuffer2.append("/").append(PropertiesUtil.getName("FTP_PATH"));
